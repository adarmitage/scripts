...
fastq-mcf $ILLUMINA_ADAPTERS $EXTENDED_READ -o $EXTENDED_READ_TRIM -C 1000000 -u -k 20 -t 0.01 -q 20 -p 5

fastq-mcf $ILLUMINA_ADAPTERS $F_REMAINDER $R_REMAINDER -o $F_REMAINDER_TRIM -o $R_REMAINDER_TRIM -C 1000000 -u -k 20 -t 0.01 -q 20 -p 5
